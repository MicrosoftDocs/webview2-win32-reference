...
[COREWEBVIEW2_CERTIFICATE_KIND](#corewebview2_certificate_kind) | Specifies the certificate kind.
[COREWEBVIEW2_CERTIFICATE_KIND](#corewebview2_certificate_kind) | Specifies the certificate kind.
...
When the page calls `postMessage`, the object parameter is converted to a JSON string and is posted asynchronously to the host process. This will result in the handlers `Invoke` method being called with the JSON string as its parameter.
...
#### COREWEBVIEW2_CERTIFICATE_KIND

Specifies the certificate kind.

> enum [COREWEBVIEW2_CERTIFICATE_KIND](#corewebview2_certificate_kind)

 Values                         | Descriptions
--------------------------------|---------------------------------------------
COREWEBVIEW2_CERTIFICATE_KIND_SMART_CARD            | Specifies smart card certificate.
COREWEBVIEW2_CERTIFICATE_KIND_PIN            | Specifies PIN certificate.
COREWEBVIEW2_CERTIFICATE_KIND_OTHER            | Specifies other certificate.

#### COREWEBVIEW2_CERTIFICATE_KIND

Specifies the certificate kind.

> typedef [COREWEBVIEW2_CERTIFICATE_KIND](#corewebview2_certificate_kind)
