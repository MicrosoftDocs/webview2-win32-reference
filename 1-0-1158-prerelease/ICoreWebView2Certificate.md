...
Read more about DER at [RFC 7468 DER] ([https://tools.ietf.org/html/rfc7468#appendix-B](https://tools.ietf.org/html/rfc7468#appendix-B)).
...
> public HRESULT [get_Kind](#get_kind)(COREWEBVIEW2_CERTIFICATE_KIND * value)
...
Returns Base64 encoding of DER encoded certificate. Read more about PEM at [RFC 1421 Privacy Enhanced Mail] ([https://tools.ietf.org/html/rfc1421](https://tools.ietf.org/html/rfc1421)).
