---
description: This interface is an extension of ICoreWebView2 to support ServerCertificateErrorDetected event.
title: WebView2 Win32 C++ ICoreWebView2Experimental15
ms.date: 05/02/2022
keywords: IWebView2, IWebView2WebView, webview2, webview, win32 apps, win32, edge, ICoreWebView2, ICoreWebView2Controller, browser control, edge html, ICoreWebView2Experimental15
---

# interface ICoreWebView2Experimental15
...
This interface is an extension of ICoreWebView2 to support ServerCertificateErrorDetected event.
...
> public HRESULT [add_ServerCertificateErrorDetected](#add_servercertificateerrordetected)([ICoreWebView2ExperimentalServerCertificateErrorDetectedEventHandler](icorewebview2experimentalservercertificateerrordetectedeventhandler.md) * eventHandler, EventRegistrationToken * token)
...
> public HRESULT [ClearServerCertificateErrorActions](#clearservercertificateerroractions)([ICoreWebView2ExperimentalClearServerCertificateErrorActionsCompletedHandler](icorewebview2experimentalclearservercertificateerroractionscompletedhandler.md) * handler)
