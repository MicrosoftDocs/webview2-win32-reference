...
> public HRESULT [GetEffectiveAllowedPortRange](#geteffectiveallowedportrange)([COREWEBVIEW2_ALLOWED_PORT_RANGE_SCOPE](https://learn.microsoft.com/en-us/microsoft-edge/webview2/reference/win32/webview2experimental-idl?view=webview2-1.0.4181-prerelease#corewebview2_allowed_port_range_scope) scope, [COREWEBVIEW2_TRANSPORT_PROTOCOL_KIND](https://learn.microsoft.com/en-us/microsoft-edge/webview2/reference/win32/webview2experimental-idl?view=webview2-1.0.4181-prerelease#corewebview2_transport_protocol_kind) protocol, INT32 * minPort, INT32 * maxPort)
