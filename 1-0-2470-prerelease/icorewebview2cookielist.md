...
See [ICoreWebView2Cookie](icorewebview2cookie.md#icorewebview2cookie). 
```cpp
    if (m_cookieManager)
    {
...
> public HRESULT [GetValueAtIndex](#getvalueatindex)(UINT index, [ICoreWebView2Cookie](icorewebview2cookie.md#icorewebview2cookie) ** cookie)
