...
Represents a Basic HTTP authentication response that contains a user name and a password as according to RFC7617 ([https://tools.ietf.org/html/rfc7617](https://tools.ietf.org/html/rfc7617))
