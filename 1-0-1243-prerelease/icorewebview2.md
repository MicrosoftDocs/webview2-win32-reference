...
[COREWEBVIEW2_BROWSER_PROCESS_EXIT_KIND](#corewebview2_browser_process_exit_kind) | Specifies the browser process exit type used in the `[ICoreWebView2BrowserProcessExitedEventArgs](icorewebview2browserprocessexitedeventargs.md)` interface.
[COREWEBVIEW2_BROWSING_DATA_KINDS](#corewebview2_browsing_data_kinds) | Specifies the datatype for the `[ICoreWebView2Profile2::ClearBrowsingData](icorewebview2profile2.md)` method.
...
[COREWEBVIEW2_CONTEXT_MENU_ITEM_KIND](#corewebview2_context_menu_item_kind) | Specifies the menu item kind for the `[ICoreWebView2ContextMenuItem::get_Kind](icorewebview2contextmenuitem.md)` method.
[COREWEBVIEW2_CONTEXT_MENU_TARGET_KIND](#corewebview2_context_menu_target_kind) | Indicates the kind of context for which the context menu was created for the `[ICoreWebView2ContextMenuTarget::get_Kind](icorewebview2contextmenutarget.md)` method.
...
--------- | --------- | --------- | ---------
`*`|[https://contoso.com/a/b/c](https://contoso.com/a/b/c)|Yes  |A single * will match all URIs
`*://contoso.com/*`|[https://contoso.com/a/b/c](https://contoso.com/a/b/c)|Yes  |Matches everything in contoso.com across all schemes
`*://contoso.com/*`|[https://example.com/?https://contoso.com/](https://example.com/?https://contoso.com/)|Yes  |But also matches a URI with just the same text anywhere in the URI
`example`|[https://contoso.com/example](https://contoso.com/example)|No  |The filter does not perform partial matches
`*example`|[https://contoso.com/example](https://contoso.com/example)|Yes  |The filter matches across URI parts
`*example`|[https://contoso.com/path/?example](https://contoso.com/path/?example)|Yes  |The filter matches across URI parts
`*example`|[https://contoso.com/path/?query#example](https://contoso.com/path/?query#example)|No  |The filter is matched against the URI with no fragment
`*example`|[https://example](https://example)|No  |The URI is normalized before filter matching so the actual URI used for comparison is [https://example.com/](https://example.com/)
`*example/`|[https://example](https://example)|Yes  |Just like above, but this time the filter ends with a / just like the normalized URI
[https://xn&ndash;qei.example/](https://xn&ndash;qei.example/)|[https://&#x2764;.example/](https://&#x2764;.example/)|Yes  |Non-ASCII hostnames are normalized to punycode before wildcard comparison
[https://&#x2764;.example/](https://&#x2764;.example/)|[https://xn&ndash;qei.example/](https://xn&ndash;qei.example/)|No  |Non-ASCII hostnames are normalized to punycode before wildcard comparison
...
Specifies the browser process exit type used in the `[ICoreWebView2BrowserProcessExitedEventArgs](icorewebview2browserprocessexitedeventargs.md)` interface.
...
Specifies the datatype for the `[ICoreWebView2Profile2::ClearBrowsingData](icorewebview2profile2.md)` method.
...
COREWEBVIEW2_BROWSING_DATA_KINDS_CACHE_STORAGE            | Specifies data stored by the CacheStorge DOM API.
...
Specifies the menu item kind for the `[ICoreWebView2ContextMenuItem::get_Kind](icorewebview2contextmenuitem.md)` method.
...
Indicates the kind of context for which the context menu was created for the `[ICoreWebView2ContextMenuTarget::get_Kind](icorewebview2contextmenutarget.md)` method.
