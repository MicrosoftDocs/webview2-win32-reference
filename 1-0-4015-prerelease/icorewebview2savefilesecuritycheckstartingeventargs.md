---
description: This is a deprecated interface to control Enhanced Security Mode (ESM) level.
...
This is a deprecated interface to control Enhanced Security Mode (ESM) level.
...
Use [ICoreWebView2ExperimentalProfile17](icorewebview2experimentalprofile17.md#icorewebview2experimentalprofile17) and `EnhancedSecurityModeState` instead. The event args for `SaveFileSecurityCheckStarting` event.
