...
title: WebView2 Win32 C++ ICoreWebView2ServiceWorker
ms.date: 05/04/2026
keywords: IWebView2, IWebView2WebView, webview2, webview, win32 apps, win32, edge, ICoreWebView2, ICoreWebView2Controller, browser control, edge html, ICoreWebView2ServiceWorker
topic_type: 
- APIRef
api_name:
- ICoreWebView2ServiceWorker
- ICoreWebView2ServiceWorker.add_Destroying
- ICoreWebView2ServiceWorker.add_WebMessageReceived
- ICoreWebView2ServiceWorker.get_ScriptUri
- ICoreWebView2ServiceWorker.PostWebMessageAsJson
- ICoreWebView2ServiceWorker.PostWebMessageAsString
- ICoreWebView2ServiceWorker.remove_Destroying
- ICoreWebView2ServiceWorker.remove_WebMessageReceived
api_type:
- COM
api_location:
...
> public HRESULT [add_Destroying](#add_destroying)([ICoreWebView2ServiceWorkerDestroyingEventHandler](icorewebview2serviceworkerdestroyingeventhandler.md#icorewebview2serviceworkerdestroyingeventhandler) * eventHandler, EventRegistrationToken * token)
...
> public HRESULT [add_WebMessageReceived](#add_webmessagereceived)([ICoreWebView2ServiceWorkerWebMessageReceivedEventHandler](icorewebview2serviceworkerwebmessagereceivedeventhandler.md#icorewebview2serviceworkerwebmessagereceivedeventhandler) * eventHandler, EventRegistrationToken * token)
