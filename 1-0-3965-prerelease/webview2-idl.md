...
COREWEBVIEW2_PERMISSION_KIND_PERSISTENT_STORAGE            | Indicates permission to persist storage created by the Storage APIs, service workers, etc.
...
COREWEBVIEW2_PROCESS_FAILED_REASON_NORMAL_EXIT            | The process exited normally (exit code 0).
COREWEBVIEW2_PROCESS_FAILED_REASON_ABNORMAL_EXIT            | The process exited abnormally (non-zero exit code).
COREWEBVIEW2_PROCESS_FAILED_REASON_INTEGRITY_FAILURE            | The OS terminated the process due to a code integrity failure.
