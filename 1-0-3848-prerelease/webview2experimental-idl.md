...
[COREWEBVIEW2_ENHANCED_SECURITY_MODE_LEVEL](#corewebview2_enhanced_security_mode_level) | Enhanced Security Mode levels.
...
> enum [COREWEBVIEW2_ENHANCED_SECURITY_MODE_LEVEL](#corewebview2_enhanced_security_mode_level)

 Values                         | Descriptions
--------------------------------|---------------------------------------------
COREWEBVIEW2_ENHANCED_SECURITY_MODE_LEVEL_OFF            | Enhanced Security Mode is turned off.
COREWEBVIEW2_ENHANCED_SECURITY_MODE_LEVEL_STRICT            | Enhanced Security Mode is enabled in Strict level.
