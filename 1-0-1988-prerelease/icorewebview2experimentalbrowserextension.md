...
title: WebView2 Win32 C++ ICoreWebView2ExperimentalBrowserExtension
ms.date: 07/25/2023
keywords: IWebView2, IWebView2WebView, webview2, webview, win32 apps, win32, edge, ICoreWebView2, ICoreWebView2Controller, browser control, edge html, ICoreWebView2ExperimentalBrowserExtension
topic_type: 
- APIRef
api_name:
- ICoreWebView2ExperimentalBrowserExtension
- ICoreWebView2ExperimentalBrowserExtension.Enable
- ICoreWebView2ExperimentalBrowserExtension.get_Id
- ICoreWebView2ExperimentalBrowserExtension.get_IsEnabled
- ICoreWebView2ExperimentalBrowserExtension.get_Name
- ICoreWebView2ExperimentalBrowserExtension.Remove
api_type:
- COM
api_location:
...
> public HRESULT [Enable](#enable)(BOOL isEnabled, [ICoreWebView2ExperimentalBrowserExtensionEnableCompletedHandler](icorewebview2experimentalbrowserextensionenablecompletedhandler.md) * handler)
...
> public HRESULT [Remove](#remove)(ICoreWebView2ExperimentalBrowserExtensionRemoveCompletedHandler * handler)
