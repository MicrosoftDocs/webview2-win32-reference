...
This function has a dependency on AllowDrop property of CoreWebView2Controller and return E_FAIL to callers to indicate this operation is not allowed if AllowDrop property is set to false.
